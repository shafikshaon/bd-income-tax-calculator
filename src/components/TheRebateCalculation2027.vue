...
const rebateAmount = computed(() => {
  // Bangladesh tax law for 2026-2027: Rebate is the lowest of:
  ...
  return Math.min(calculatedRebate, calculateTax.value)
})
...
const minimumTax = computed(() => {
  // For 2026-27: Minimum tax is BDT 5,000 for taxpayers with taxable income above tax-free threshold
    ...
    <div class="card-body">
      ...
      <div class="alert alert-info mb-3">
        <div class="row text-center">
          <div class="col-4">
            <small class="text-muted">Gross Income</small><br>
            <strong>৳{{ formatNumber(totalGrossPay) }}</strong>
          </div>
          <div class="col-4">
            <small class="text-muted">Tax-Free (Max ৳5,00,000)</small><br>
            <strong>৳{{ formatNumber(taxFreeIncome) }}</strong>
          </div>
          <div class="col-4">
            <small class="text-muted">Taxable Income</small><br>
            <strong class="text-primary">৳{{ formatNumber(taxableIncome) }}</strong>
          </div>
        </div>
      </div>
      ...
      <div class="table-responsive">
        <table class="table table-sm table-bordered">
          ...
          <tr class="table-success">
            ...
            <td class="text-end"><strong>{{ formatNumber(rebateAmount) }}</strong></td>
          </tr>
